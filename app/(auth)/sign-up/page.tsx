            ...
            <div className='flex flex-col rounded-md bg-white/9 border gap-5 border-gray-300/30 p-9 justify-center items-center'>
                ...
                <div className='flex w-full flex-col justify-center gap-3 items-center'>
                    <div className='grid w-full items-center gap-3'>
                        ...
                        <Input type="text" id="text" className='bg-white/20 text-white h-10 placeholder:text-white'/>
                    </div>
                    <div className='grid w-full items-center gap-3'>
                ...
                <div className='w-full justify-between flex'>
                    <div className='flex items-center justify-center gap-2'>
                      ...
                      <Label>I agree to the <span className='text-pink-400'>Terms of Service</span> and <span className='text-pink-400'>Privacy Policy</span></Label>
                    </div>
                </div>
